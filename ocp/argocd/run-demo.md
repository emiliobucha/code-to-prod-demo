...
1. Add the Git repository for our application to Argo CD
    ...
    ~~~sh
    argocd repo add https://gitlab.com/emiliobucha/reverse-words-cicd.git --name reversewords-cicd
    ~~~
...
3. Define Development application
    ...
    --repo https://gitlab.com/emiliobucha/reverse-words-cicd.git \
    --path . \
...
1. We will configure the first webhook on the app repo
    ...
    1. Go to your application repository on gitlab, eg: https://gitlab.com/emiliobucha/reverse-words
...
2. Now, we will configure the second webhook to react to changes on the cicd repository
    ...
    1. Go to your cicd repository on gitlab, eg: https://gitlab.com/emiliobucha/reverse-words-cicd
    2. Click on `Settings` -> `Webhooks`
    3. Create the following `Hook`
...
4. Create the repository object for polling
    ...
    spec:
      url: https://gitlab.com/emiliobucha/reverse-words.git
      ref: main
      frequency: 1m
      type: gitlab
      pipelineRef:
